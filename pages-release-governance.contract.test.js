...
assert.ok(artifactBuilder.includes('SRC工具/core/src-column-core.js') && artifactBuilder.includes('SRC工具/core/src-column-h-section-catalog.js') && artifactBuilder.includes('SRC工具/core/src-column-rc-biaxial.js') && artifactBuilder.includes('SRC工具/core/src-column-shear.js') && artifactBuilder.includes('SRC工具/core/src-column-weak-axis-shear-reference.js') && artifactBuilder.includes('SRC工具/core/src-column-seismic-axial.js') && artifactBuilder.includes('SRC工具/core/src-column-seismic-detailing.js') && artifactBuilder.includes('SRC工具/core/src-column-oracle.js') && artifactBuilder.includes('SRC工具/src-column.html') && artifactBuilder.includes('SRC工具/src-column.css') && artifactBuilder.includes('SRC工具/src-column.js') && artifactBuilder.includes('SRC工具/src-column-page.contract.test.js') && artifactBuilder.includes('SRC工具/src-column-browser-smoke.test.js') && artifactBuilder.includes('SRC工具/src-column-traceability.catalog.json'), 'shared artifact builder keeps the SRC column research page, core, sourced catalog, seismic subchecks, external comparison, and oracle private');
assert.ok(pagesSmoke.includes('SRC工具/core/src-column-core.js') && pagesSmoke.includes('SRC工具/core/src-column-h-section-catalog.js') && pagesSmoke.includes('SRC工具/core/src-column-rc-biaxial.js') && pagesSmoke.includes('SRC工具/core/src-column-shear.js') && pagesSmoke.includes('SRC工具/core/src-column-weak-axis-shear-reference.js') && pagesSmoke.includes('SRC工具/core/src-column-seismic-axial.js') && pagesSmoke.includes('SRC工具/core/src-column-seismic-detailing.js') && pagesSmoke.includes('SRC工具/core/src-column-oracle.js') && pagesSmoke.includes('SRC工具/src-column.html') && pagesSmoke.includes('SRC工具/src-column.css') && pagesSmoke.includes('SRC工具/src-column.js') && pagesSmoke.includes('SRC工具/src-column-page.contract.test.js') && pagesSmoke.includes('SRC工具/src-column-browser-smoke.test.js') && pagesSmoke.includes('SRC工具/src-column-core.test.js') && pagesSmoke.includes('SRC工具/src-column-h-section-catalog.test.js') && pagesSmoke.includes('SRC工具/src-column-rc-biaxial.test.js') && pagesSmoke.includes('SRC工具/src-column-shear.test.js') && pagesSmoke.includes('SRC工具/src-column-seismic-axial.test.js') && pagesSmoke.includes('SRC工具/src-column-seismic-detailing.test.js') && pagesSmoke.includes('SRC工具/src-column-oracle.test.js') && pagesSmoke.includes('SRC工具/src-column-traceability.catalog.json'), 'Pages private-boundary smoke probes every SRC column research asset');
const { classifyPublishedPath } = require(artifactBuilderPath);
for (const researchPath of ['SRC工具/core/src-column-core.js', 'SRC工具/core/src-column-h-section-catalog.js', 'SRC工具/core/src-column-rc-biaxial.js', 'SRC工具/core/src-column-shear.js', 'SRC工具/core/src-column-weak-axis-shear-reference.js', 'SRC工具/core/src-column-seismic-axial.js', 'SRC工具/core/src-column-seismic-detailing.js', 'SRC工具/core/src-column-oracle.js', 'SRC工具/src-column.html', 'SRC工具/src-column.css', 'SRC工具/src-column.js', 'SRC工具/src-column-page.contract.test.js', 'SRC工具/src-column-browser-smoke.test.js', 'SRC工具/src-column-core.test.js', 'SRC工具/src-column-h-section-catalog.test.js', 'SRC工具/src-column-rc-biaxial.test.js', 'SRC工具/src-column-shear.test.js', 'SRC工具/src-column-seismic-axial.test.js', 'SRC工具/src-column-seismic-detailing.test.js', 'SRC工具/src-column-oracle.test.js', 'SRC工具/src-column-traceability.catalog.json']) {
  assert.deepEqual(classifyPublishedPath(researchPath), { publish: false, reason: 'private-tooling' }, `${researchPath} is excluded by exact Pages policy`);
}
...
assert.ok(pagesWorkflow.includes('timeout-minutes: 10') && pagesWorkflow.includes('.expired == false') && pagesWorkflow.includes('historical evidence excluded'), 'Pages trend bounds collection and explicitly excludes incomplete historical evidence');
assert.ok(pagesWorkflow.includes('sort_by(.created_at, .id) | last | .id') && pagesWorkflow.includes('historical evidence deduplicated'), 'Pages trend deterministically selects the newest receipt after workflow reruns');
assert.ok(pagesWorkflow.includes('actions/artifacts/$build_id/zip') && pagesWorkflow.includes('actions/artifacts/$live_id/zip') &&
  !pagesWorkflow.includes('actions/artifacts/$build_id/zip" >/dev/null') && !pagesWorkflow.includes('actions/artifacts/$live_id/zip" >/dev/null'), 'Pages trend downloads selected governed receipts by exact artifact id without suppressing failures');
...
assert.ok(
  pagesBrowserSmoke.includes("routes.push('/rc', '/toolbox-classic')") &&
    ...
    pagesBrowserSmoke.includes("'/wind-force':") &&
    pagesBrowserSmoke.includes("'/seismic-force':") &&
    pagesBrowserSmoke.includes("'/stone-fixing':") &&
  ...
  'Pages browser smoke renders shared launcher and formal family boundaries without suppressing steel private-audit failures'
);
