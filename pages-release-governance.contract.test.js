...
assert.ok([31, 32, 33, 36].includes(reportReadinessStatus.renderedDeliveryEvidenceRequired), 'report readiness covers the previous release or promoted formal homepage portfolio');
