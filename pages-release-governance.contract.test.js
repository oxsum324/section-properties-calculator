...
assert.ok(artifactBuilder.includes('SRC工具/core/src-column-core.js') && artifactBuilder.includes('SRC工具/src-column-traceability.catalog.json'), 'shared artifact builder keeps the SRC column research core private');
assert.ok(pagesSmoke.includes('SRC工具/core/src-column-core.js') && pagesSmoke.includes('SRC工具/src-column-core.test.js') && pagesSmoke.includes('SRC工具/src-column-traceability.catalog.json'), 'Pages private-boundary smoke probes every SRC column research asset');
const { classifyPublishedPath } = require(artifactBuilderPath);
for (const researchPath of ['SRC工具/core/src-column-core.js', 'SRC工具/src-column-core.test.js', 'SRC工具/src-column-traceability.catalog.json']) {
