...
git add -- ".github/workflows/pages-deploy.yml" ".github/workflows/pr-validation.yml" "run-pages-artifact-smoke.ps1" "pages-release-governance.contract.test.js" "pr-validation.contract.test.js"
