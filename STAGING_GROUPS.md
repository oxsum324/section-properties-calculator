...
- `鋼構工具/core/materials/steel.js`、`steel-beam-formal.html`、`steel-beam-formal.js`、`steel-formal.regression-test.js`
...
此組需一起提交，避免只有測試案例卻沒有 production core、preflight、成熟度與報告邊界。試辦通過只可標示 7 / 7，整體正式入口需同時標示 7 / 31；golden case 或同核心結果鏈不等同獨立工程驗證，也不得算入獨立覆蓋。
