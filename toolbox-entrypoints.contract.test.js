...
assert.ok(pagesArtifactBuilder.includes('attachment-package-check.js') && pagesArtifactBuilder.includes('attachment-package-build.js') && pagesArtifactBuilder.includes('attachment-package-verify.js') && pagesArtifactBuilder.includes('attachment-package-upgrade-assess.js') && pagesArtifactBuilder.includes('rendered-delivery-evidence.inventory.json'), 'shared Pages artifact builder excludes governance helpers');
assert.ok(pagesLiveSmoke.includes('attachment-package-upgrade-assess.js'), 'Pages private-boundary smoke blocks the attachment upgrade assessor');
