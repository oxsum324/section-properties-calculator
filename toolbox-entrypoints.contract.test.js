...
assert.ok(pagesArtifactBuilder.includes('attachment-package-check.js') && pagesArtifactBuilder.includes('attachment-package-build.js') && pagesArtifactBuilder.includes('attachment-package-verify.js') && pagesArtifactBuilder.includes('attachment-package-upgrade-assess.js') && pagesArtifactBuilder.includes('attachment-package-upgrade-workspace.js') && pagesArtifactBuilder.includes('attachment-package-upgrade-workspace-check.js') && pagesArtifactBuilder.includes('attachment-package-upgrade-flow.js') && pagesArtifactBuilder.includes('attachment-package-upgrade-history.js') && pagesArtifactBuilder.includes('attachment-package-upgrade-history-index.js') && pagesArtifactBuilder.includes('rendered-delivery-evidence.inventory.json'), 'shared Pages artifact builder excludes governance helpers');
assert.ok(pagesLiveSmoke.includes('attachment-package-upgrade-assess.js') && pagesLiveSmoke.includes('attachment-package-upgrade-workspace.js') && pagesLiveSmoke.includes('attachment-package-upgrade-workspace-check.js') && pagesLiveSmoke.includes('attachment-package-upgrade-flow.js') && pagesLiveSmoke.includes('attachment-package-upgrade-history.js') && pagesLiveSmoke.includes('attachment-package-upgrade-history-index.js'), 'Pages private-boundary smoke blocks the attachment upgrade helpers');
