...
<html lang="zh-Hant">
  ...
  <body>
    ...
    <main>
      ...
      <section class="card">
        <h2>破壞模式檢核</h2>
        ${W.size>0?`<p class="meta">註：已排除 ${W.size} 項「不檢討」檢核（${[...W].map(u).join(`、`)}）</p>`:``}
        <table>
