...
目前試辦涵蓋設備局部荷重、乾土 Rankine 主動土壓、矩形基礎外力底壓、矩形 RC 柱平衡附近 P–M 控制點、RC 獨立基腳撓曲／單向剪力／衝剪、RC 單樁軸向承載／群樁反力／樁帽強度、正式鋼梁 ASD 的 F2 非彈性側向扭轉挫屈／G2 剪力／服務性撓度，以及正式鋼柱 ASD 的弱軸挫屈與雙向壓彎互制，共 8 / 8 路由通過；31 個正式入口的整體獨立驗證覆蓋為 8 / 31。風力、地震力與錨栓列為 P0 後續基準。試辦狀態只留在盤點與首頁頁面診斷，不寫入計算書或正式附件。
