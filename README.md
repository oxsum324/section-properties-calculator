...
目前試辦涵蓋設備局部荷重、乾土 Rankine 主動土壓、矩形基礎外力底壓、矩形 RC 柱平衡附近 P–M 控制點、矩形 RC 梁正負撓曲／最小鋼筋／耐震 Ve 控制且 Vc 歸零剪力、RC 獨立基腳撓曲／單向剪力／衝剪、RC 單樁軸向承載／群樁反力／樁帽強度、正式鋼梁 ASD 的 F2 非彈性側向扭轉挫屈／G2 剪力／服務性撓度、正式鋼柱 ASD 的弱軸挫屈與雙向壓彎互制、正式風力的剛性三層矩形建物雙方向 MWFRS、正式地震力的八層 RC 構架等值靜力與樓層分配，以及正式錨栓的 2×2 預埋 M20 第 17 章拉剪強度與互制逐項手算，共 12 / 12 路由通過；31 個正式入口的整體獨立驗證覆蓋為 12 / 31。原列 P0 的風力、地震力與錨栓已全部完成；目前 P1 依序為 RC 剪力牆、實體標示物風力、鋼構連接板及 RC 板。`/seismic-dynamic` 的首頁身分為分析摘要而非正式附件入口，日後可補充驗證，但不計入 31 個正式入口覆蓋。試辦狀態只留在盤點與首頁頁面診斷，不寫入計算書或正式附件。
