const CACHE = 'condition-survey-shell-0.4.1-r1';
const ASSETS = ['./recorder.html', './app.css', './app.js', './model.js', './store.js', './bundle.js', './annotation.js', './sketch.js', './manifest.webmanifest', './icon.svg', './icon-192.png', './icon-512.png'];
