const CACHE = 'condition-survey-shell-0.12.0-r1';
const ASSETS = ['./recorder.html', './app.css', './app.js', './model.js', './report.js', './report-ui.js', './report-standard.js', './organisation.js', './detail.js', './store.js', './bundle.js', './annotation.js', './sketch.js', './stairs.js', './cracks.js', './plan-labels.js', './label-editor.js', './manifest.webmanifest', './icon.svg', './icon-192.png', './icon-512.png'];
