...
export async function verifyV010(browser, base, out) {
  ...
  try {
    ...
    await click(first + ' [data-do=edit-detail]'); assert.equal(await page.locator('[data-detail-preset]').count(), 14); assert(!(await page.locator('#modalBody').innerText()).includes('圖層'));
