...
(async () => {
  ...
  try {
    ...
    for (const name of process.argv.slice(2).length ? process.argv.slice(2) : ['report', 'v010']) {
      const selected = { floors: ['standard-floor-browser.js', 'verifyStandardFloors'], v017: ['v017-browser.js', 'verifyV017'], v016: ['v016-browser.js', 'verifyV016'], v015: ['v015-browser.js', 'verifyV015'], v014: ['v014-browser.js', 'verifyV014'], v013: ['v013-browser.js', 'verifyV013'], v012: ['v012-browser.js', 'verifyV012'], v011: ['v011-browser.js', 'verifyV011'], report: ['report-browser.js', 'verifyReportWorkflow'], v010: ['v010-browser.js', 'verifyV010'], v08: ['field-v08-browser.js', 'verifyFieldV08Workflow'], scale: ['scale-browser.js', 'verifyScale'] }[name];
