...
def main() -> int:
    ...
    require_all([
        ...
        ('clear confirmation is shown before clearing backup', 'confirm(clearRecoveryConfirmMessage(info))' in html),
        ('restore confirmation is shown before restoring backup', 'confirm(restoreRecoveryConfirmMessage(info))' in html),
    ...
    require_all([
        ...
        ('migration persistence failure status is exported', "migration_persist_status: 'failed'" in html),
