...
def main() -> int:
    ...
    require_all([
        ...
        ('migration persistence failure status is exported', "migrated.meta.migration_persist_status = 'failed'" in html),
