...
[
  ...
  'report starts from calculation inputs',
  '適用範圍假設',
  '適用範圍與模型邊界',
  '內建案例',
  'c@Pu 不採用',
  ...
  "'V0.4'",
  "'RC Shear Wall', '計算書', 'V0.4'",
  "'Ag/Ach', 'ccore'",
  'report exposes both Ash equations and governing equation',
  'report exposes Ach boundary dimension source',
  'screenshotQuality',
  'pdfTextQuality',
