...
const PUBLIC_ROUTE_SAMPLES = [
  { path: 'field-survey/recorder.html', needles: ['現況鑑定紀錄 V0.7.0', './manifest.webmanifest', './app.js', '備份還原', '原始照片'], checkAssets: true },
  { path: 'field-survey/sw.js', needles: ['condition-survey-shell-0.7.0', './sketch.js', 'cache.addAll', 'ACTIVATE_UPDATE'] },
