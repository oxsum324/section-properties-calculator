...
const PUBLIC_ROUTE_SAMPLES = [
  ...
  { path: '連續梁分析.html', needles: ['連續梁分析工具', 'analysis-section-tool-metadata.js', 'CONTINUOUS_BEAM_PUBLIC_VERSION', 'CONTINUOUS_BEAM_CALCULATION_ENGINE', '結構工具箱/core/direct-print-boundary.css', 'formal-tool-output-page', '分析工具主頁列印已封鎖'] },
...
async function main() {
  ...
  assert.ok([32, 33, 36].includes(reportReadinessStatus.renderedDeliveryEvidenceRequired), 'report readiness rendered delivery covers a supported formal homepage portfolio');
