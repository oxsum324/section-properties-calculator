...
function isCompleteRenderedDeliveryEvidence(evidence, runId) {
  ...
  const formalHtmlDualSealDeclared = Number(evidence?.schemaVersion) >= 19;
  ...
  return Boolean(
    ...
    && (!completeIntegrityDeclared || (
      ...
      && evidence.rcVisualArtifactIntegrity.required === (pileGroupLateralRcEvidenceDeclared ? 66 : earthBridgeRcEvidenceDeclared ? 64 : 62)
      && evidence.rcVisualArtifactIntegrity.verified === (pileGroupLateralRcEvidenceDeclared ? 66 : earthBridgeRcEvidenceDeclared ? 64 : 62)
    ...
    && (!rcResultReconciliationDeclared || (
      ...
      && evidence.rcResultReconciliation.required === (pileGroupLateralRcEvidenceDeclared ? 34 : earthBridgeRcEvidenceDeclared ? 33 : expandedRcResultReconciliationDeclared ? 32 : 30)
      && evidence.rcResultReconciliation.complete === (pileGroupLateralRcEvidenceDeclared ? 34 : earthBridgeRcEvidenceDeclared ? 33 : expandedRcResultReconciliationDeclared ? 32 : 30)
    ...
    && (!rcSourceReportPackageDeclared || (
      ...
      && evidence.rcSourceReportPackage.complete === 32
      && evidence.rcSourceReportPackage.issueCount === 0
      && evidence.rcSourceReportPackage.pass === true
      && /^[0-9a-f]{64}$/i.test(String(evidence.rcSourceReportPackage.setSha256 || ''))
    ))
    && (!rcStandaloneFormalHtmlPrintDeclared || (
      ...
      && evidence.rcStandaloneFormalHtmlPrint.complete === 34
      && evidence.rcStandaloneFormalHtmlPrint.issueCount === 0
      && evidence.rcStandaloneFormalHtmlPrint.pass === true
      && /^[0-9a-f]{64}$/i.test(String(evidence.rcStandaloneFormalHtmlPrint.setSha256 || ''))
    ))
    && (!rcFormalHtmlContentSealDeclared || (
      ...
      && evidence.rcFormalHtmlContentSeal.complete === 34
    ...
    && (!formalHtmlDualSealDeclared || (
      ...
      && evidence.formalHtmlContentSeal.complete === 14
      && evidence.formalHtmlContentSeal.issueCount === 0
      && evidence.formalHtmlContentSeal.pass === true
      && /^[0-9a-f]{64}$/i.test(String(evidence.formalHtmlContentSeal.setSha256 || ''))
      ...
      && evidence.formalHtmlApprovalSeal.complete === 14
      && evidence.formalHtmlApprovalSeal.issueCount === 0
      && evidence.formalHtmlApprovalSeal.pass === true
      && /^[0-9a-f]{64}$/i.test(String(evidence.formalHtmlApprovalSeal.setSha256 || ''))
    ))
    ...
    && (!anchorHtmlDualSealDeclared || (
      ...
      && evidence.anchorHtmlContentSeal.complete === 1
      && evidence.anchorHtmlContentSeal.issueCount === 0
      && evidence.anchorHtmlContentSeal.pass === true
      && /^[0-9a-f]{64}$/i.test(String(evidence.anchorHtmlContentSeal.setSha256 || ''))
      ...
      && evidence.anchorHtmlApprovalSeal.complete === 1
      && evidence.anchorHtmlApprovalSeal.issueCount === 0
      && evidence.anchorHtmlApprovalSeal.pass === true
      && /^[0-9a-f]{64}$/i.test(String(evidence.anchorHtmlApprovalSeal.setSha256 || ''))
    ))
    ...
    && (!stoneResultReconciliationDeclared || (
      ...
      && evidence.stoneResultReconciliation.complete === 1
      && evidence.stoneResultReconciliation.issueCount === 0
      && evidence.stoneResultReconciliation.pass === true
      && /^[0-9a-f]{64}$/i.test(String(evidence.stoneResultReconciliation.setSha256 || ''))
    ))
    && (!anchorResultReconciliationDeclared || (
      ...
      && evidence.anchorResultReconciliation.complete === 1
    ...
    && (!excavationResultReconciliationDeclared || (
      ...
      && evidence.excavationResultReconciliation.complete === 1
      && evidence.excavationResultReconciliation.issueCount === 0
      && evidence.excavationResultReconciliation.pass === true
      && /^[0-9a-f]{64}$/i.test(String(evidence.excavationResultReconciliation.setSha256 || ''))
    ))
...
function buildHomepageReportReadinessStatus(matrixPayload, sourceHash, preflightStatus = null, preflightPayload = null, renderedDeliveryEvidence = null) {
  ...
  const rcResultReconciliationRequired = rcResultReconciliationDeclared ? compactNumber(rcResultReconciliation.required) : 0;
  const rcResultReconciliationComplete = rcResultReconciliationDeclared ? compactNumber(rcResultReconciliation.complete) : 0;
  const rcResultReconciliationIssueCount = !rcResultReconciliationDeclared
    ? 0
    : rcResultReconciliation.pass === true
      ? Math.max(0, rcResultReconciliationRequired - rcResultReconciliationComplete)
      : Math.max(1, compactNumber(rcResultReconciliation.issueCount) || rcResultReconciliationRequired - rcResultReconciliationComplete);
  const rcSourceReportPackage = renderedDeliveryPayload?.rcSourceReportPackage;
  const rcSourceReportPackageDeclared = Boolean(
    Number(renderedDeliveryPayload?.schemaVersion) >= 15
    && rcSourceReportPackage
    && rcSourceReportPackage.scope === 'rc-real-source-json-to-formal-html-package-check'
    && Number.isInteger(rcSourceReportPackage.required)
    && Number.isInteger(rcSourceReportPackage.complete)
  );
  const rcSourceReportPackageRequired = rcSourceReportPackageDeclared ? compactNumber(rcSourceReportPackage.required) : 0;
  const rcSourceReportPackageComplete = rcSourceReportPackageDeclared ? compactNumber(rcSourceReportPackage.complete) : 0;
  const rcSourceReportPackageIssueCount = !rcSourceReportPackageDeclared
    ? 0
    : rcSourceReportPackage.pass === true
      ? Math.max(0, rcSourceReportPackageRequired - rcSourceReportPackageComplete)
      : Math.max(1, compactNumber(rcSourceReportPackage.issueCount) || rcSourceReportPackageRequired - rcSourceReportPackageComplete);
  const rcStandaloneFormalHtmlPrint = renderedDeliveryPayload?.rcStandaloneFormalHtmlPrint;
  const rcStandaloneFormalHtmlPrintDeclared = Boolean(
    Number(renderedDeliveryPayload?.schemaVersion) >= 16
    && rcStandaloneFormalHtmlPrint
    && rcStandaloneFormalHtmlPrint.scope === 'rc-approved-standalone-html-to-validated-pdf'
    && Number.isInteger(rcStandaloneFormalHtmlPrint.required)
    && Number.isInteger(rcStandaloneFormalHtmlPrint.complete)
  );
  const rcStandaloneFormalHtmlPrintRequired = rcStandaloneFormalHtmlPrintDeclared ? compactNumber(rcStandaloneFormalHtmlPrint.required) : 0;
  const rcStandaloneFormalHtmlPrintComplete = rcStandaloneFormalHtmlPrintDeclared ? compactNumber(rcStandaloneFormalHtmlPrint.complete) : 0;
  const rcStandaloneFormalHtmlPrintIssueCount = !rcStandaloneFormalHtmlPrintDeclared
    ? 0
    : rcStandaloneFormalHtmlPrint.pass === true
      ? Math.max(0, rcStandaloneFormalHtmlPrintRequired - rcStandaloneFormalHtmlPrintComplete)
      : Math.max(1, compactNumber(rcStandaloneFormalHtmlPrint.issueCount) || rcStandaloneFormalHtmlPrintRequired - rcStandaloneFormalHtmlPrintComplete);
  const rcFormalHtmlContentSeal = renderedDeliveryPayload?.rcFormalHtmlContentSeal;
  const rcFormalHtmlContentSealDeclared = Boolean(
    Number(renderedDeliveryPayload?.schemaVersion) >= 17
    && rcFormalHtmlContentSeal
    && rcFormalHtmlContentSeal.scope === 'rc-formal-html-reproducible-content-sha256'
    && Number.isInteger(rcFormalHtmlContentSeal.required)
    && Number.isInteger(rcFormalHtmlContentSeal.complete)
  );
  const rcFormalHtmlContentSealRequired = rcFormalHtmlContentSealDeclared ? compactNumber(rcFormalHtmlContentSeal.required) : 0;
  const rcFormalHtmlContentSealComplete = rcFormalHtmlContentSealDeclared ? compactNumber(rcFormalHtmlContentSeal.complete) : 0;
  const rcFormalHtmlContentSealIssueCount = !rcFormalHtmlContentSealDeclared
    ? 0
  ...
  const formalHtmlDualSealDeclared = Boolean(
    Number(renderedDeliveryPayload?.schemaVersion) >= 19
    && formalHtmlContentSeal?.scope === 'formal-tools-html-reproducible-content-sha256'
    && formalHtmlApprovalSeal?.scope === 'formal-tools-html-reproducible-approval-sha256'
    && Number.isInteger(formalHtmlContentSeal.required)
    && Number.isInteger(formalHtmlContentSeal.complete)
    && Number.isInteger(formalHtmlApprovalSeal.required)
    && Number.isInteger(formalHtmlApprovalSeal.complete)
  );
  const formalHtmlContentSealRequired = formalHtmlDualSealDeclared ? compactNumber(formalHtmlContentSeal.required) : 0;
  const formalHtmlContentSealComplete = formalHtmlDualSealDeclared ? compactNumber(formalHtmlContentSeal.complete) : 0;
  const formalHtmlContentSealIssueCount = !formalHtmlDualSealDeclared
    ? 0
    : formalHtmlContentSeal.pass === true
      ? Math.max(0, formalHtmlContentSealRequired - formalHtmlContentSealComplete)
      : Math.max(1, compactNumber(formalHtmlContentSeal.issueCount) || formalHtmlContentSealRequired - formalHtmlContentSealComplete);
  const formalHtmlApprovalSealRequired = formalHtmlDualSealDeclared ? compactNumber(formalHtmlApprovalSeal.required) : 0;
  const formalHtmlApprovalSealComplete = formalHtmlDualSealDeclared ? compactNumber(formalHtmlApprovalSeal.complete) : 0;
  const formalHtmlApprovalSealIssueCount = !formalHtmlDualSealDeclared
    ? 0
    : formalHtmlApprovalSeal.pass === true
      ? Math.max(0, formalHtmlApprovalSealRequired - formalHtmlApprovalSealComplete)
      : Math.max(1, compactNumber(formalHtmlApprovalSeal.issueCount) || formalHtmlApprovalSealRequired - formalHtmlApprovalSealComplete);
  const steelHtmlContentSeal = renderedDeliveryPayload?.steelHtmlContentSeal;
  const steelHtmlApprovalSeal = renderedDeliveryPayload?.steelHtmlApprovalSeal;
  const steelHtmlDualSealDeclared = Boolean(
    Number(renderedDeliveryPayload?.schemaVersion) >= 20
    && steelHtmlContentSeal?.scope === 'steel-formal-html-reproducible-content-sha256'
    && steelHtmlApprovalSeal?.scope === 'steel-formal-html-reproducible-approval-sha256'
    && Number.isInteger(steelHtmlContentSeal.required)
    && Number.isInteger(steelHtmlContentSeal.complete)
    && Number.isInteger(steelHtmlApprovalSeal.required)
    && Number.isInteger(steelHtmlApprovalSeal.complete)
  );
  const steelHtmlContentSealRequired = steelHtmlDualSealDeclared ? compactNumber(steelHtmlContentSeal.required) : 0;
  const steelHtmlContentSealComplete = steelHtmlDualSealDeclared ? compactNumber(steelHtmlContentSeal.complete) : 0;
  const steelHtmlContentSealIssueCount = !steelHtmlDualSealDeclared
    ? 0
    : steelHtmlContentSeal.pass === true
      ? Math.max(0, steelHtmlContentSealRequired - steelHtmlContentSealComplete)
      : Math.max(1, compactNumber(steelHtmlContentSeal.issueCount) || steelHtmlContentSealRequired - steelHtmlContentSealComplete);
  const steelHtmlApprovalSealRequired = steelHtmlDualSealDeclared ? compactNumber(steelHtmlApprovalSeal.required) : 0;
  const steelHtmlApprovalSealComplete = steelHtmlDualSealDeclared ? compactNumber(steelHtmlApprovalSeal.complete) : 0;
  const steelHtmlApprovalSealIssueCount = !steelHtmlDualSealDeclared
    ? 0
    : steelHtmlApprovalSeal.pass === true
      ? Math.max(0, steelHtmlApprovalSealRequired - steelHtmlApprovalSealComplete)
      : Math.max(1, compactNumber(steelHtmlApprovalSeal.issueCount) || steelHtmlApprovalSealRequired - steelHtmlApprovalSealComplete);
  const anchorHtmlContentSeal = renderedDeliveryPayload?.anchorHtmlContentSeal;
  const anchorHtmlApprovalSeal = renderedDeliveryPayload?.anchorHtmlApprovalSeal;
  const anchorHtmlDualSealDeclared = Boolean(
    Number(renderedDeliveryPayload?.schemaVersion) >= 21
    && anchorHtmlContentSeal?.scope === 'anchor-formal-html-reproducible-content-sha256'
    && anchorHtmlApprovalSeal?.scope === 'anchor-formal-html-reproducible-approval-sha256'
    && Number.isInteger(anchorHtmlContentSeal.required)
    && Number.isInteger(anchorHtmlContentSeal.complete)
    && Number.isInteger(anchorHtmlApprovalSeal.required)
    && Number.isInteger(anchorHtmlApprovalSeal.complete)
  );
  const anchorHtmlContentSealRequired = anchorHtmlDualSealDeclared ? compactNumber(anchorHtmlContentSeal.required) : 0;
  const anchorHtmlContentSealComplete = anchorHtmlDualSealDeclared ? compactNumber(anchorHtmlContentSeal.complete) : 0;
  const anchorHtmlContentSealIssueCount = !anchorHtmlDualSealDeclared
    ? 0
    : anchorHtmlContentSeal.pass === true
      ? Math.max(0, anchorHtmlContentSealRequired - anchorHtmlContentSealComplete)
      : Math.max(1, compactNumber(anchorHtmlContentSeal.issueCount) || anchorHtmlContentSealRequired - anchorHtmlContentSealComplete);
  const anchorHtmlApprovalSealRequired = anchorHtmlDualSealDeclared ? compactNumber(anchorHtmlApprovalSeal.required) : 0;
  const anchorHtmlApprovalSealComplete = anchorHtmlDualSealDeclared ? compactNumber(anchorHtmlApprovalSeal.complete) : 0;
  const anchorHtmlApprovalSealIssueCount = !anchorHtmlDualSealDeclared
    ? 0
    : anchorHtmlApprovalSeal.pass === true
      ? Math.max(0, anchorHtmlApprovalSealRequired - anchorHtmlApprovalSealComplete)
      : Math.max(1, compactNumber(anchorHtmlApprovalSeal.issueCount) || anchorHtmlApprovalSealRequired - anchorHtmlApprovalSealComplete);
  ...
  const steelResultReconciliationDeclared = Boolean(
    ...
    && steelResultReconciliation.scope === 'steel-source-replay-to-report-fingerprint'
    && Number.isInteger(steelResultReconciliation.required)
    && Number.isInteger(steelResultReconciliation.complete)
  );
  const steelResultReconciliationRequired = steelResultReconciliationDeclared ? compactNumber(steelResultReconciliation.required) : 0;
  const steelResultReconciliationComplete = steelResultReconciliationDeclared ? compactNumber(steelResultReconciliation.complete) : 0;
  const steelResultReconciliationIssueCount = !steelResultReconciliationDeclared
    ? 0
  ...
  const stoneResultReconciliationDeclared = Boolean(
    ...
    && stoneResultReconciliation.scope === 'stone-golden-replay-to-pdf-docx-hash'
    && Number.isInteger(stoneResultReconciliation.required)
    && Number.isInteger(stoneResultReconciliation.complete)
  );
  const stoneResultReconciliationRequired = stoneResultReconciliationDeclared ? compactNumber(stoneResultReconciliation.required) : 0;
  const stoneResultReconciliationComplete = stoneResultReconciliationDeclared ? compactNumber(stoneResultReconciliation.complete) : 0;
  const stoneResultReconciliationIssueCount = !stoneResultReconciliationDeclared
    ? 0
    : stoneResultReconciliation.pass === true
      ? Math.max(0, stoneResultReconciliationRequired - stoneResultReconciliationComplete)
      : Math.max(1, compactNumber(stoneResultReconciliation.issueCount) || stoneResultReconciliationRequired - stoneResultReconciliationComplete);
  const anchorResultReconciliation = renderedDeliveryPayload?.anchorResultReconciliation;
  const anchorResultReconciliationDeclared = Boolean(
    Number(renderedDeliveryPayload?.schemaVersion) >= 9
    && anchorResultReconciliation
    && anchorResultReconciliation.scope === 'anchor-workspace-replay-to-html-docx-xlsx-hash'
    && Number.isInteger(anchorResultReconciliation.required)
    && Number.isInteger(anchorResultReconciliation.complete)
  );
  const anchorResultReconciliationRequired = anchorResultReconciliationDeclared ? compactNumber(anchorResultReconciliation.required) : 0;
  const anchorResultReconciliationComplete = anchorResultReconciliationDeclared ? compactNumber(anchorResultReconciliation.complete) : 0;
  const anchorResultReconciliationIssueCount = !anchorResultReconciliationDeclared
    ? 0
  ...
  const excavationResultReconciliation = renderedDeliveryPayload?.excavationResultReconciliation;
  const excavationResultReconciliationDeclared = Boolean(
    Number(renderedDeliveryPayload?.schemaVersion) >= 11
    && excavationResultReconciliation
    && excavationResultReconciliation.scope === 'excavation-project-state-replay-to-pdf-docx-hash'
    && Number.isInteger(excavationResultReconciliation.required)
    && Number.isInteger(excavationResultReconciliation.complete)
  );
  const excavationResultReconciliationRequired = excavationResultReconciliationDeclared ? compactNumber(excavationResultReconciliation.required) : 0;
  const excavationResultReconciliationComplete = excavationResultReconciliationDeclared ? compactNumber(excavationResultReconciliation.complete) : 0;
  const excavationResultReconciliationIssueCount = !excavationResultReconciliationDeclared
    ? 0
    : excavationResultReconciliation.pass === true
      ? Math.max(0, excavationResultReconciliationRequired - excavationResultReconciliationComplete)
      : Math.max(1, compactNumber(excavationResultReconciliation.issueCount) || excavationResultReconciliationRequired - excavationResultReconciliationComplete);
  const localQuickResultReconciliation = renderedDeliveryPayload?.localQuickResultReconciliation;
  const localQuickResultReconciliationDeclared = Boolean(
    Number(renderedDeliveryPayload?.schemaVersion) >= 12
    && localQuickResultReconciliation
    && localQuickResultReconciliation.scope === 'local-quick-json-replay-to-pdf-hash'
    && Number.isInteger(localQuickResultReconciliation.required)
    && Number.isInteger(localQuickResultReconciliation.complete)
  );
  ...
  return {
    ...
    ...(formalHtmlDualSealDeclared ? {
      ...
      formalHtmlContentSealComplete,
      formalHtmlContentSealIssueCount,
      formalHtmlContentSealPass: formalHtmlContentSeal.pass === true
        && formalHtmlContentSealComplete === formalHtmlContentSealRequired
        && formalHtmlContentSealIssueCount === 0,
      formalHtmlApprovalSealRequired,
      formalHtmlApprovalSealComplete,
      formalHtmlApprovalSealIssueCount,
      formalHtmlApprovalSealPass: formalHtmlApprovalSeal.pass === true
        && formalHtmlApprovalSealComplete === formalHtmlApprovalSealRequired
        && formalHtmlApprovalSealIssueCount === 0,
    } : {}),
    ...(steelHtmlDualSealDeclared ? {
      steelHtmlContentSealRequired,
      steelHtmlContentSealComplete,
      steelHtmlContentSealIssueCount,
      steelHtmlContentSealPass: steelHtmlContentSeal.pass === true
        && steelHtmlContentSealComplete === steelHtmlContentSealRequired
        && steelHtmlContentSealIssueCount === 0,
      steelHtmlApprovalSealRequired,
      steelHtmlApprovalSealComplete,
      steelHtmlApprovalSealIssueCount,
      steelHtmlApprovalSealPass: steelHtmlApprovalSeal.pass === true
        && steelHtmlApprovalSealComplete === steelHtmlApprovalSealRequired
        && steelHtmlApprovalSealIssueCount === 0,
    } : {}),
    ...(anchorHtmlDualSealDeclared ? {
      anchorHtmlContentSealRequired,
      anchorHtmlContentSealComplete,
      anchorHtmlContentSealIssueCount,
      anchorHtmlContentSealPass: anchorHtmlContentSeal.pass === true
        && anchorHtmlContentSealComplete === anchorHtmlContentSealRequired
        && anchorHtmlContentSealIssueCount === 0,
      anchorHtmlApprovalSealRequired,
      anchorHtmlApprovalSealComplete,
      anchorHtmlApprovalSealIssueCount,
      anchorHtmlApprovalSealPass: anchorHtmlApprovalSeal.pass === true
        && anchorHtmlApprovalSealComplete === anchorHtmlApprovalSealRequired
        && anchorHtmlApprovalSealIssueCount === 0,
    } : {}),
    ...(rcResultReconciliationDeclared ? {
      rcResultReconciliationRequired,
      rcResultReconciliationComplete,
      rcResultReconciliationIssueCount,
      rcResultReconciliationPass: rcResultReconciliation.pass === true
        && rcResultReconciliationComplete === rcResultReconciliationRequired
        && rcResultReconciliationIssueCount === 0,
    } : {}),
    ...(rcSourceReportPackageDeclared ? {
      rcSourceReportPackageRequired,
      rcSourceReportPackageComplete,
      rcSourceReportPackageIssueCount,
      rcSourceReportPackagePass: rcSourceReportPackage.pass === true
        && rcSourceReportPackageComplete === rcSourceReportPackageRequired
        && rcSourceReportPackageIssueCount === 0,
    } : {}),
    ...(rcStandaloneFormalHtmlPrintDeclared ? {
      rcStandaloneFormalHtmlPrintRequired,
      rcStandaloneFormalHtmlPrintComplete,
      rcStandaloneFormalHtmlPrintIssueCount,
      rcStandaloneFormalHtmlPrintPass: rcStandaloneFormalHtmlPrint.pass === true
        && rcStandaloneFormalHtmlPrintComplete === rcStandaloneFormalHtmlPrintRequired
        && rcStandaloneFormalHtmlPrintIssueCount === 0,
    } : {}),
    ...(rcFormalHtmlContentSealDeclared ? {
      rcFormalHtmlContentSealRequired,
      rcFormalHtmlContentSealComplete,
      rcFormalHtmlContentSealIssueCount,
    ...
    ...(steelResultReconciliationDeclared ? {
      ...
      steelResultReconciliationComplete,
      steelResultReconciliationIssueCount,
      steelResultReconciliationPass: steelResultReconciliation.pass === true
        && steelResultReconciliationComplete === steelResultReconciliationRequired
        && steelResultReconciliationIssueCount === 0,
    } : {}),
    ...(stoneResultReconciliationDeclared ? {
      stoneResultReconciliationRequired,
      stoneResultReconciliationComplete,
      stoneResultReconciliationIssueCount,
      stoneResultReconciliationPass: stoneResultReconciliation.pass === true
        && stoneResultReconciliationComplete === stoneResultReconciliationRequired
        && stoneResultReconciliationIssueCount === 0,
    } : {}),
    ...(anchorResultReconciliationDeclared ? {
      anchorResultReconciliationRequired,
      anchorResultReconciliationComplete,
      anchorResultReconciliationIssueCount,
    ...
    ...(excavationResultReconciliationDeclared ? {
      ...
      excavationResultReconciliationComplete,
      excavationResultReconciliationIssueCount,
      excavationResultReconciliationPass: excavationResultReconciliation.pass === true
        && excavationResultReconciliationComplete === excavationResultReconciliationRequired
        && excavationResultReconciliationIssueCount === 0,
    } : {}),
    ...(localQuickResultReconciliationDeclared ? {
      localQuickResultReconciliationRequired,
      localQuickResultReconciliationComplete,
      localQuickResultReconciliationIssueCount,
      localQuickResultReconciliationPass: localQuickResultReconciliation.pass === true
        && localQuickResultReconciliationComplete === localQuickResultReconciliationRequired
        && localQuickResultReconciliationIssueCount === 0,
    } : {}),
...
function checkMatrix(payload, markdown, options = {}) {
  ...
  assert.equal(payload.independentBenchmarkCoverage.summary.pilotVerified, 17, 'tool maturity matrix independent benchmark pilot verified');
  assert.equal(payload.independentBenchmarkCoverage.summary.pilotRequired, 17, 'tool maturity matrix independent benchmark pilot required');
  assert.equal(payload.independentBenchmarkCoverage.summary.independentlyVerifiedRoutes, 17, 'tool maturity matrix independent benchmark verified route count');
  ...
  if (preserveHomepageStatus) {
    ...
    assert.ok(homepageReportReadinessStatus.independentBenchmarkVerified >= 0 && homepageReportReadinessStatus.independentBenchmarkVerified <= 16, 'preserved homepage report readiness independent benchmark verified routes bounded by current coverage');
    ...
    assert.equal(homepageReportReadinessStatus.independentBenchmarkVerified, 16, 'homepage report readiness independent benchmark verified routes');
    assert.equal(homepageReportReadinessStatus.independentBenchmarkPilotRequired, 16, 'homepage report readiness independent benchmark pilot required');
    assert.equal(homepageReportReadinessStatus.independentBenchmarkPilotVerified, 16, 'homepage report readiness independent benchmark pilot verified');
  }
  ...
  if (Number.isInteger(homepageReportReadinessStatus.deliveryFileIntegrityRequired)) {
    assert.ok([135, 137, 139].includes(homepageReportReadinessStatus.deliveryFileIntegrityRequired), 'homepage report readiness exposes a supported verified delivery-file transition count');
  ...
  if (Number.isInteger(homepageReportReadinessStatus.steelResultReconciliationRequired)) {
    ...
    assert.ok((homepageReportReadinessStatus.details || []).join(' ').includes('鋼構正式計算書結果鏈'), 'homepage report readiness explains steel result reconciliation');
    assert.ok((homepageReportReadinessStatus.details || []).join(' ').includes('不公開來源資料、來源雜湊或計算指紋'), 'homepage report readiness keeps steel reconciliation evidence private');
  }
  if (Number.isInteger(homepageReportReadinessStatus.stoneResultReconciliationRequired)) {
    assert.equal(homepageReportReadinessStatus.stoneResultReconciliationRequired, 1, 'homepage report readiness expects 1 stone result reconciliation');
    assert.equal(homepageReportReadinessStatus.stoneResultReconciliationComplete, homepageReportReadinessStatus.stoneResultReconciliationRequired, 'homepage report readiness completes the stone result reconciliation');
    assert.equal(homepageReportReadinessStatus.stoneResultReconciliationIssueCount, 0, 'homepage report readiness stone result reconciliation issues empty');
    assert.equal(homepageReportReadinessStatus.stoneResultReconciliationPass, true, 'homepage report readiness stone result reconciliation passes');
    assert.ok((homepageReportReadinessStatus.details || []).join(' ').includes('石材正式計算書結果鏈'), 'homepage report readiness explains stone result reconciliation');
    assert.ok((homepageReportReadinessStatus.details || []).join(' ').includes('不公開 golden 案例資料、來源 payload 雜湊、結果雜湊或成品雜湊'), 'homepage report readiness keeps stone reconciliation evidence private');
  }
  if (Number.isInteger(homepageReportReadinessStatus.anchorResultReconciliationRequired)) {
    assert.equal(homepageReportReadinessStatus.anchorResultReconciliationRequired, 1, 'homepage report readiness expects 1 anchor result reconciliation');
    assert.equal(homepageReportReadinessStatus.anchorResultReconciliationComplete, homepageReportReadinessStatus.anchorResultReconciliationRequired, 'homepage report readiness completes the anchor result reconciliation');
    assert.equal(homepageReportReadinessStatus.anchorResultReconciliationIssueCount, 0, 'homepage report readiness anchor result reconciliation issues empty');
  ...
  if (Number.isInteger(homepageReportReadinessStatus.excavationResultReconciliationRequired)) {
    assert.equal(homepageReportReadinessStatus.excavationResultReconciliationRequired, 1, 'homepage report readiness expects 1 excavation result reconciliation');
    assert.equal(homepageReportReadinessStatus.excavationResultReconciliationComplete, homepageReportReadinessStatus.excavationResultReconciliationRequired, 'homepage report readiness completes the excavation result reconciliation');
    assert.equal(homepageReportReadinessStatus.excavationResultReconciliationIssueCount, 0, 'homepage report readiness excavation result reconciliation issues empty');
    assert.equal(homepageReportReadinessStatus.excavationResultReconciliationPass, true, 'homepage report readiness excavation result reconciliation passes');
    assert.ok((homepageReportReadinessStatus.details || []).join(' ').includes('開挖擋土支撐正式計算書結果鏈'), 'homepage report readiness explains excavation result reconciliation');
    assert.ok((homepageReportReadinessStatus.details || []).join(' ').includes('不公開 ProjectState、輸入／結果資料、計算指紋或成品雜湊'), 'homepage report readiness keeps excavation reconciliation evidence private');
  }
  if (Number.isInteger(homepageReportReadinessStatus.supplementalDeliveryEvidenceRequired)) {
    ...
    assert.ok(homepageReportReadinessStatus.supplementalDeliveryEvidenceFamilies.some(item => item.family === 'excavation-formal' && item.complete === 1), 'homepage report readiness supplemental delivery keeps excavation service coverage');
    if (homepageReportReadinessStatus.supplementalDeliveryEvidenceRequired === 2) {
      assert.deepEqual(homepageReportReadinessStatus.supplementalDeliveryEvidenceFamilies, [{ family: 'excavation-formal', complete: 1 }, { family: 'seismic-report', complete: 1 }], 'homepage report readiness supplemental delivery covers report and service families');
