...
assertIncludes(repoDocs.homeHtml, '開挖支撐與斜撐匯入亦已保留逐階段內力候選及唯一控制階段', 'new home roadmap records completed analysis-stage mapping');
assertIncludes(repoDocs.homeHtml, '拆撐／重撐傳力路徑、支撐內力完整時序包絡及 SRC 構件能力', 'new home roadmap points to the next deeper construction-stage capabilities');
...
assertIncludes(repoDocs.indexClassic, '開挖支撐與斜撐匯入也已保留逐階段內力候選、唯一控制階段及實際施工步驟明確對應', 'classic home records completed analysis-stage mapping');
assertIncludes(repoDocs.indexClassic, '拆撐／重撐傳力路徑、支撐內力完整時序包絡及 SRC 構件能力', 'classic home lists next construction-stage capability expansion');
