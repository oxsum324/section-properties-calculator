...
assertIncludes(repoDocs.homeHtml, '支撐內力隨施工階段變化、跨柱反力分配及 SRC 構件能力', 'new home roadmap points to the next deeper construction-stage capabilities');
...
assertIncludes(repoDocs.indexClassic, '支撐內力隨施工階段變化、跨柱反力分配及 SRC 構件能力', 'classic home lists next construction-stage capability expansion');
