...
assert.equal(formalManifest.version, '0.4.1', 'formal tools manifest version');
...
[
  ...
  'hasCanonicalHomeLink',
  'hasDirectPrintBoundary',
  'no duplicate tool cards',
  'no duplicate version claims',
  'no expiring NEW claims',
  'horizontalOverflow',
...
[
  ...
  '"contractTest"',
  '"browserSmokeTest"',
  '"approvalMetadataChangePolicy": "revoke-and-reapprove"',
  '"maturityMatrix"',
  '"requiredRoutes"',
  '"reportForbiddenNeedles"',
  '"reportDisclosureNeedles"',
...
assertIncludes(repoDocs.homeHtml, '開挖支撐與斜撐匯入已保留完整軸力時序', 'new home roadmap records completed analysis-stage force history');
...
for (const tool of tools) {
  ...
  if (tool.key === 'equipment-load') {
    [
      ...
      '鋼板分散彎曲初判',
      'id="reactionMode"',
      'value="eccentric-rectangular-4"',
      'id="supportSpacingX"',
      'id="supportSpacingY"',
      'id="cgEccentricityX"',
      'id="cgEccentricityY"',
      'Ri = W/n + My·xi/Σx² + Mx·yi/Σy²',
      'Rmin&lt;0',
      'equipment-load-core.js?v=0.3.0',
      'id="concreteFc"',
      'id="effectiveDepth"',
