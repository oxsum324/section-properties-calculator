...
assertIncludes(repoDocs.homeHtml, '逐階段明確採用附加 X／Y 偏心與依據', 'new home records completed stage-specific eccentricity adoption');
assertIncludes(repoDocs.homeHtml, '開挖支撐與斜撐匯入亦已保留各有效施工階段的軸力時序及唯一控制階段', 'new home roadmap records completed analysis-stage force history');
assertIncludes(repoDocs.homeHtml, '拆撐／重撐承接構造驗算及 SRC 構件能力', 'new home roadmap points to the next deeper construction-stage capabilities');
...
assertIncludes(repoDocs.indexClassic, '開挖支撐與斜撐匯入也已保留各有效施工階段的軸力時序、唯一控制階段及實際施工步驟明確對應', 'classic home records completed analysis-stage force history');
assertIncludes(repoDocs.indexClassic, '拆撐／重撐承接構造驗算及 SRC 構件能力', 'classic home lists next construction-stage capability expansion');
