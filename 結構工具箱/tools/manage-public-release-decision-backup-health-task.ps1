...
if ($Action -eq 'Install') {
  ...
  Register-ScheduledTask -TaskName $taskName -Action $taskAction -Trigger $trigger -Settings $settings -Principal $principal -Description 'Validates private release decision backup mirrors without publishing paths, IDs, hashes, or receipt content.' -Force | Out-Null
}
