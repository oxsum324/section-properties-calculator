...
(function (global) {
  ...
  // 常用城市快捷 (UI 用)
  const CITY_QUICK = {
    '臺北市':   42.5, '新北市':   37.5, '基隆市':   42.5,
    '桃園市':   37.5, '新竹市':   32.5, '新竹縣':   32.5,
    '苗栗縣':   32.5, '臺中市':   32.5, '彰化縣':   32.5,
    '南投縣':   27.5, '雲林縣':   32.5, '嘉義市':   27.5,
    '嘉義縣':   27.5, '臺南市':   37.5, '高雄市':   37.5,
    '屏東縣':   37.5, '宜蘭縣':   37.5, '花蓮縣':   42.5,
    '臺東縣':   37.5, '澎湖縣':   33.0, '金門縣':   35.0,
    '連江縣':   42.0, '蘭嶼/綠島': 65.0,
  };
  ...
  // ═══════════════════════════════
  const IMPORTANCE = {
    I:   { name: '第一類 (重要 — 醫院/消防)', factor: 1.10 },
    II:  { name: '第二類 (危險物品)',         factor: 1.10 },
    III: { name: '第三類 (公眾使用)',         factor: 1.10 },
    IV:  { name: '第四類 (臨時/次要)',       factor: 0.90 },
    V:   { name: '第五類 (一般建築)',         factor: 1.00 },
  };
