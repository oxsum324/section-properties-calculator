(function () {
  ...
  const HOME_TOOL_UPDATES = {
    ...
    routes: {
      ...
      '/wind-force': '2026-08-15',
      '/wind-cc': '2026-08-15',
      '/wind-parapet': '2026-08-15',
      '/wind-open-roof': '2026-08-15',
      '/wind-object-solid': '2026-08-15',
      '/wind-object-frame': '2026-08-15',
      '/wind-lattice-tower': '2026-08-15',
      '/wind-object-tower': '2026-08-15',
      '/wind-fence-sign': '2026-08-15',
      '/wind-sign-pole': '2026-08-15',
      '/seismic-force': '2026-08-15',
      '/seismic-dynamic': '2026-08-15',
  ...
  const HOME_TOOL_UPDATE_DEPENDENCIES = {
    version: 1,
    routes: {
      '/beam-analysis': ['結構工具箱/tools/project-meta-profile.js'],
      '/frame-analysis': ['結構工具箱/tools/project-meta-profile.js'],
      '/composite-section': ['結構工具箱/tools/project-meta-profile.js'],
