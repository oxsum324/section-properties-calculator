(function () {
  ...
  const HOME_TOOL_UPDATE_DEPENDENCIES = {
    ...
    routes: {
      ...
      '/steel-beam-formal': ['鋼構工具/steel-beam-formal.js', '結構工具箱/tools/project-meta-profile.js'],
      '/steel-column-formal': ['鋼構工具/steel-column-formal.js', '結構工具箱/tools/project-meta-profile.js'],
  ...
  const tools = [
    ...
    },
    {
      ...
      summary: '獨立、聯合、筏式、樁基與擋土牆基礎，含單向雙向剪力、撓曲、設計與檢核；懸臂式主動土壓 JSON 可經同版核心驗證後銜接牆身設計。',
      fit: '正式基礎配筋與強度檢核。',
    ...
    },
    {
      ...
      limit: '基礎埋置、被動土壓動員位移仍需判斷；懸臂式主動土壓可銜接 RC 牆身設計，趾踵版配筋與地震載重組合需另行正式詳算。',
      capabilities: ['正式核算', '計算書', '示意圖']
    },
    {
      title: '覆工板系統計算',
