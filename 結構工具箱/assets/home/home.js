(function () {
  ...
  const tools = [
    ...
    },
    {
      ...
      state: 'formal',
      output: '底壓/偏心/抗滑/抗傾覆、Meyerhof 有效面積承壓、立即彈性沉陷、中央核示意圖、兩段式計算書與 JSON',
      summary: '矩形淺基礎服務載重底壓、合力偏心、抗滑與抗傾覆檢核，依台灣 112 基礎構造設計規範安全係數；可選用 Meyerhof 有效面積承壓與立即彈性沉陷初估，含中央核示意圖與詳算式/簡易結果計算書。',
      fit: '矩形獨立基礎與設備基座之局部穩定正式檢核。',
      limit: '衝剪、配筋、壓密沉陷、液化、樁基與土壤互制不在本頁範圍，需回 RC 基礎完整工具。',
