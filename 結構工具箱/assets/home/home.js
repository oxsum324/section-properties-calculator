(function () {
  ...
  const tools = [
    ...
    },
    {
      ...
      output: '位移、反力、樓層反應、M/V/N 內力圖、計算書與 JSON',
      summary: '2D 剛架直接勁度法：節點／集中／均布／自重載重、端部鉸接釋放，支援以 JSON 重播模型並輸出位移、反力、樓層側移角、層剪力、控制樓層、內力圖與計算書；工作頁案例庫可載入固定柱腳側推、對稱載重、3–4–5 斜桿懸臂、水平／轉動彈簧支承、對稱及不對稱二層單跨剛架，逐項比對獨立參考值與求解誤差。',
      fit: '簡化剛架模型、連續梁與手算前後校核。',
      limit: '複雜工程模型仍應回正式分析軟體。',
      capabilities: ['樓層反應', '鉸接釋放', '互動驗證案例', '計算書']
    },
    {
