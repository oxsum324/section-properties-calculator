(function () {
  ...
  const tools = [
    ...
    },
    {
      ...
      output: '位移、反力、具名組合樓層包絡、M/V/N 內力圖、計算書與 JSON',
      summary: '2D 剛架直接勁度法：節點／集中／均布／自重載重、端部鉸接釋放，支援具名載重組合的建立、切換與 JSON 重播；目前組合輸出位移、反力及 M/V/N 圖，全部組合另形成各層位移角與層剪力包絡並標示控制組合，計算書同步列出組合矩陣與包絡結果。工作頁案例庫可逐項比對七組獨立參考值與求解誤差。',
      fit: '簡化剛架模型、連續梁與手算前後校核。',
      limit: '複雜工程模型仍應回正式分析軟體。',
      capabilities: ['具名載重組合', '樓層反應包絡', '互動驗證案例', '計算書']
    },
    {
