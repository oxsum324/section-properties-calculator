(function () {
  ...
  const HOME_TOOL_UPDATE_DEPENDENCIES = {
    ...
    routes: {
      ...
      '/seismic-force': ['結構工具箱/core/ui/report.js', '結構工具箱/tools/project-meta-profile.js', '結構工具箱/core/loads/project-location.js'],
      '/seismic-dynamic': ['結構工具箱/core/ui/report.js', '結構工具箱/tools/project-meta-profile.js', '結構工具箱/core/loads/project-location.js'],
      '/seismic-appendage': ['結構工具箱/core/ui/report.js', '結構工具箱/tools/project-meta-profile.js', '結構工具箱/core/loads/project-location.js'],
      '/seismic-misc': ['結構工具箱/core/ui/report.js', '結構工具箱/tools/project-meta-profile.js', '結構工具箱/core/loads/project-location.js'],
  ...
  const tools = [
    ...
    },
    {
      ...
      output: '支撐構件檢核、重撐軸壓／雙向彎矩承接、PDF/DOCX 報表與案件資料庫',
      summary: 'FastAPI + React + SQLite 工作流，匯入分析檔、構件與基礎檢核、受限 H 型鋼重撐軸壓或軸壓加雙向彎矩實算，以及 PDF/DOCX 報表。',
